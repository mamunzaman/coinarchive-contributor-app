...
export function coinFormValuesFromSubmission(source: CoinSubmissionSource): CoinFormValues {
  ...
  const baseValues = {
    ...
    year: source.year ? String(source.year) : firstNonEmptyTrimmed(acf?.coin_year),
    ...
    short_description: firstNonEmptyTrimmed(source.short_description, acf?.coin_short_description),
    coin_designer: firstNonEmptyTrimmed(acf?.coin_designer, extended.coin_designer),
    coin_theme: firstNonEmptyTrimmed(acf?.coin_theme),
    released_date: firstNonEmptyTrimmed(acf?.released_date),
